...
function getWinnersByYear(array, getYearsCB, getWinnersCB) { //assign to variables and map over result of getWinner
    let years = getYearsCB(array, getFinals); //task 3 returns all years of the finals
